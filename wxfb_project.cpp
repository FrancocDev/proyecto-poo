...
WxfbPersonaEditar::WxfbPersonaEditar( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	this->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNFACE ) );
	...
	// Connect Events
	m_agregar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPersonaEditar::OnClickAgregarPersona ), NULL, this );
	m_canelar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPersonaEditar::OnClickCancelarPersona ), NULL, this );
}

WxfbPersonaEditar::~WxfbPersonaEditar()
{
	// Disconnect Events
	m_agregar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPersonaEditar::OnClickAgregarPersona ), NULL, this );
	m_canelar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPersonaEditar::OnClickCancelarPersona ), NULL, this );
...
WxfbVendedorEditar::WxfbVendedorEditar( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	this->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNFACE ) );
	...
	// Connect Events
	m_agregar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVendedorEditar::OnClickAgregarSeller ), NULL, this );
	m_canelar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVendedorEditar::OnClickCancelarSeller ), NULL, this );
}

WxfbVendedorEditar::~WxfbVendedorEditar()
{
	// Disconnect Events
	m_agregar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVendedorEditar::OnClickAgregarSeller ), NULL, this );
	m_canelar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVendedorEditar::OnClickCancelarSeller ), NULL, this );
...
WxfbProductoEditar::WxfbProductoEditar( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	this->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNFACE ) );
	...
	// Connect Events
	m_agregar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProductoEditar::OnClickAgregarProducto ), NULL, this );
	m_canelar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProductoEditar::OnClickCancelarProducto ), NULL, this );
}

WxfbProductoEditar::~WxfbProductoEditar()
{
	// Disconnect Events
	m_agregar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProductoEditar::OnClickAgregarProducto ), NULL, this );
	m_canelar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProductoEditar::OnClickCancelarProducto ), NULL, this );
...
WxfbVentaEditar::WxfbVentaEditar( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxSize( -1,-1 ), wxDefaultSize );
	this->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNFACE ) );
	...
	// Connect Events
	m_agregarproducto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::addProductToOrder ), NULL, this );
	m_orderGrid1->Connect( wxEVT_GRID_CELL_LEFT_DCLICK, wxGridEventHandler( WxfbVentaEditar::OnDobleClickGrilla ), NULL, this );
	m_orderGrid1->Connect( wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler( WxfbVentaEditar::OnClickGrilla ), NULL, this );
	m_agregar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::OnClickAgregarVenta ), NULL, this );
	m_canelar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::OnClickCancelarVenta ), NULL, this );
}

WxfbVentaEditar::~WxfbVentaEditar()
{
	// Disconnect Events
	m_agregarproducto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::addProductToOrder ), NULL, this );
	m_orderGrid1->Disconnect( wxEVT_GRID_CELL_LEFT_DCLICK, wxGridEventHandler( WxfbVentaEditar::OnDobleClickGrilla ), NULL, this );
	m_orderGrid1->Disconnect( wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler( WxfbVentaEditar::OnClickGrilla ), NULL, this );
	m_agregar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::OnClickAgregarVenta ), NULL, this );
	m_canelar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbVentaEditar::OnClickCancelarVenta ), NULL, this );
